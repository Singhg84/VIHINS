...
if($semesterid == 1){ 
					...
					<tr>
						<td colspan="9">&nbsp;</td>
							...
							<table style="width:100%;font-size:8.5px;" border="1" align="center">
								<tr style="font-size:10px;">
									<th rowspan="2" style="width:8%" valign="middle"><br/><br/>COURSE NO.</th>
									<th rowspan="2" style="width:6%"  valign="middle"><br/><br/>Group/<br/>Unit</th>
									<th rowspan="2" style="width:28%" valign="middle"><br/><br/>COURSE TITLE </th>
									<th rowspan="2" style="width:6%" valign="middle"><br/><br/>FULL<br/>MARKS</th>
									<th colspan="3" style="width:27%" valign="middle">MARKS OBTAINED</th>
									<th rowspan="2" style="width:7%" valign="middle"><br/><br/>LETTER<br/>GRADE</th>
									<th rowspan="2" style="width:6%" valign="middle"><br/><br/>GRADE POINT</th>
									<th rowspan="2" style="width:6%" valign="middle"><br/><br/>CREDIT</th>
									<th rowspan="2" style="width:6%" valign="middle"><br/><br/>CREDIT<br/>POINTS</th>
								</tr>  
								<tr>
									<th valign="middle"><br/>INTERNAL<br/>ASSESSMENT<br/>(05/10)</th>
									<th valign="middle"><br/>END<br/>SEMESTER<br/>EXAMINATION<br/>(20/25/40)</th>
	...
	$output .='<tr style="font-size:10px;">
					...
					<tr>&nbsp;</tr>';
						...
						$output .='<tr style="font-size:10px;">
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$rowPrintcoursedata['course_no'].'&nbsp;</td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.($resultPrintcourseunitdata['c1']==0?'':$resultPrintcourseunitdata['c1']).''.(strlen($resultPrintcourseunitdata['c5'])>30?'<br/>':'').(isset($resultPrintcourseunitdata['c2']) && $resultPrintcourseunitdata['c2']==0?'':(isset($resultPrintcourseunitdata['c2'])?$resultPrintcourseunitdata['c2']:'')).'<br/></td>';
						$output .='<td style="vertical-align:middle;"><br/><br/>'.$resultPrintcourseunitdata['c5'].'<br/></td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintcourseunitdata['c3'].'<br/></td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintmarksdata['md1'].'<br/></td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintmarksdata['md3'].'<br/></td>';
$output .='<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintmarksdatamaster['rm_total_marks'].'<br/></td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintmarksdatamaster['rm_letter_grade'].'<br/></td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintmarksdatamaster['rm_grade_points'].'<br/></td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$rowPrintcoursedata['course_credit'].'<br/></td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintmarksdatamaster['rm_credit_points'].'<br/></td>
					</tr>';
						}
			...
			while($rowPrintcoursedata = $resultPrintcoursedata->fetch_assoc()){
				if($courseprcount == 1 && $rowPrintcoursedata['course_paper_type'] == 'Practical'){
					...
					$output .='<tr style="font-size:10px;">
						...
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintcourseunitdata['c3'].'<br/><br/>'.(strlen($resultPrintcourseunitdata['c5'])>34?'<br/>':'').$resultPrintcourseunitdata['c4'].'<br/></td>
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/><br/><br/></td>
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdata['md3'].'<br/><br/>'.(strlen($resultPrintcourseunitdata['c5'])>34?'<br/>':'').$resultPrintmarksdata['md4'].'<br/></td>
					...
					$output .='<tr style="font-size:10px;">
						<td style="vertical-align : middle;text-align:center;"><br/><br/><br/>'.$rowPrintcoursedata['course_no'].'<br/>&nbsp;</td>
						<td style="vertical-align:middle;text-align:center;"><br/><br/>'.$resultPrintcourseunitdata['c1'].'<br/><br/>'.(strlen($resultPrintcourseunitdata['c5'])>34?'<br/>':'').$resultPrintcourseunitdata['c2'].'<br/></td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/>'.$resultPrintcourseunitdata['c5'].'<br/><br/>'.$resultPrintcourseunitdata['c6'].'<br/></td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/>'.$resultPrintcourseunitdata['c3'].'<br/><br/>'.(strlen($resultPrintcourseunitdata['c5'])>34?'<br/>':'').$resultPrintcourseunitdata['c4'].'<br/></td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/><br/><br/></td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/>'.$resultPrintmarksdata['md3'].'<br/><br/>'.(strlen($resultPrintcourseunitdata['c5'])>34?'<br/>':'').$resultPrintmarksdata['md4'].'<br/></td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdatamaster['rm_total_marks'].'</td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdatamaster['rm_letter_grade'].'</td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdatamaster['rm_grade_points'].'</td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/><br/>'.$rowPrintcoursedata['course_credit'].'</td>
						<td style="vertical-align : middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdatamaster['rm_credit_points'].'</td>
					</tr>';
				}
}
				$output .='<tr style="font-size:9px;">
		...
		if($resultPrintmarksresulttotal['rt_result'] == 'SQ'){
			$remark = 'QUALIFIED FOR '.$quali.' SEMESTER EXAMINATION<br>SQ=SEMESTER QUALIFIED';
		}elseif($resultPrintmarksresulttotal['rt_result'] == 'SNC'){
			$remark = 'SEMESTER NOT CLEAR. PROVISIONAlLY PROMOTED TO NEXT SEMESTER<br>SNC=SEMESTER NOT CLEAR';
		}else{
			$remark = 'FAILED<br>X=FAIL';
		}
$output .='<tr style="font-size:10px;">
