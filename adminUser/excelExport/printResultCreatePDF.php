...
if($semesterid == 1){ 
	...
	$yr1 = substr($yr[1],2);
      ...
      $output .= ' <table style="width:100%;">
					...
					<tr>
						<td colspan="9">&nbsp;</td>
							...
							<tr style="font-size:14px;">
								<td colspan="9" >The following is the statement of marks and grades obtained by: <b>'.strtoupper($rowPrint['stud_name']).'</b> <br/>Roll:<b>'.$rollp.' NO. '.$rowPrint['stud_roll_no'].' </b>Registration No.:<b>'.$rowPrint['stud_reg_no'].'</b> of <b>'.$rowPrint['stud_reg_year'].'</b> in  <b>M.Sc. '.$semp.'</b> SEMESTER EXAMINATION, '.$yrf.'.<BR></td>
							</tr>
							</table>
							<table style="width:100%;font-size:8.5px;" border="1" align="center">
								...
								<tr>
									<th valign="middle"><br/><br/>INTERNAL<br/>ASSESSMENT<br/>(05)</th>
									<th valign="middle"><br/><br/>END<br/>SEMESTER<br/>EXAMINATION<br/>(20/25)</th>
			...
			while($rowPrintcoursedata = $resultPrintcoursedata->fetch_assoc()){
				if($coursethcount == 1 && $rowPrintcoursedata['course_paper_type'] == 'Theory'){
					...
					$output .='<tr>
						...
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintcourseunitdata['c1'].'<br/><br/>'.$resultPrintcourseunitdata['c2'].'</td>
						<th><strong>THEORY PAPERS</strong></th>
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintcourseunitdata['c3'].'<br/><br/>'.$resultPrintcourseunitdata['c4'].'</td>
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdata['md1'].'<br/><br/>'.$resultPrintmarksdata['md2'].'</td>
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdata['md3'].'<br/><br/>'.$resultPrintmarksdata['md4'].'</td>
					...
					$output .='<tr>
						...
						<td rowspan="2" style="vertical-align:middle;text-align:center;"><br/><br/>'.($resultPrintcourseunitdata['c1']==0?'':$resultPrintcourseunitdata['c1']).'<br/><br/>'.(strlen($resultPrintcourseunitdata['c5'])>34?'<br/>':'').($resultPrintcourseunitdata['c2']==0?'':$resultPrintcourseunitdata['c2']).'<br/></td>
						<td rowspan="2" style="vertical-align:middle;"><br/><br/>'.$resultPrintcourseunitdata['c5'].'<br/><br/>'.$resultPrintcourseunitdata['c6'].'<br/></td>
						...
						<td rowspan="2"  style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdatamaster['rm_total_marks'].'<br/><br/></td>
				...
				$output .='<tr>
					<td></td>
					<td></td>
					<th><br/><br/><strong>TOTAL OF THEORY PAPERS</strong><br/><br/></th>
					<th><br/><br/><strong>'.$coursethfull.'</strong><br/><br/></th>
					<td colspan="2"></td>
					<th><br/><br/><strong>'.$coursethtotal.'</strong><br/><br/></th>
					<td></td>
					<td></td>
					<th><br/><br/><strong>'.$coursethcredit.'</strong><br/><br/></th>
					<th><br/><br/><strong>'.$coursethcreditpoint.'</strong><br/><br/></th>
				</tr>';
			...
			while($rowPrintcoursedata = $resultPrintcoursedata->fetch_assoc()){
				if($courseprcount == 1 && $rowPrintcoursedata['course_paper_type'] == 'Practical'){
					...
					$output .='<tr>
						...
						<td rowspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><br/>'.$resultPrintmarksdata['md3'].'<br/><br/>'.(strlen($resultPrintcourseunitdata['c5'])>30?'<br/>':'').$resultPrintmarksdata['md4'].'<br/><br/></td>
				...
				$output .='<tr>
					<td></td>
					<td></td>
					<th><br/><br/><strong>TOTAL OF PRACTICAL PAPERS</strong><br/><br/></th>
					<th><br/><br/><strong>'.$courseprfull.'</strong><br/><br/></th>
					<td colspan="2"></td>
					<th><br/><br/><strong>'.$courseprtotal.'</strong><br/><br/></th>
					<td></td>
					<td></td>
					<th><br/><br/><strong>'.$courseprcredit.'</strong><br/><br/></th>
					<th><br/><br/><strong>'.$courseprcreditpoint.'</strong><br/><br/></th>
				</tr>';
				
		$output .='<tr>
				<th colspan="3"><br/><br/><strong>TOTAL</strong><br/><br/></th>
				<th><br/><br/><strong>'.($courseprfull + $coursethfull).'</strong><br/><br/></th>
				<td></td>
				<td></td>
				<th><br/><br/><strong>'.($coursethtotal + $courseprtotal).'</strong><br/><br/></th>
				<td></td>
				<td></td>
				<th><br/><br/><strong>'.($coursethcredit + $courseprcredit).'</strong><br/><br/></th>
				<th><br/><br/><strong>'.($coursethcreditpoint + $courseprcreditpoint).'</strong><br/><br/></th>
        </tr>
        <tr>
            <th colspan="2" style="vertical-align:middle;text-align:center;"><br/><br/><strong>SGPA OF 3<SUP>rd</SUP> SEMESTER</strong><br/></th>
		...
		if($tpercent < 30){
			$res = 'X';
			$remark = 'SEMESTER NOT QUALIFIED';
		}else{
			$res = 'SQ';
			$remark = 'QUALIFIED FOR '.$quali.' SEMESTER EXAMINATION';
		}
$output .='<tr>
            <td colspan="2" style="vertical-align:middle;text-align:center;"><br/><br/><strong>'.number_format((float)round(($coursethcreditpoint + $courseprcreditpoint)/($coursethcredit + $courseprcredit),2, PHP_ROUND_HALF_DOWN),2,'.',',').'</strong><br/></td>
            <td style="vertical-align:middle;text-align:center;"><br/><br/><strong>'.$tpercent.'</strong><br/></td>
            <td colspan="3" style="vertical-align:middle;text-align:center;"><br/><br/><strong>'.$res.'</strong><br/></td>
