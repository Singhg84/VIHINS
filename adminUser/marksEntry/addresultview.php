...
//				exit;
				$rv_stud_id 		= $line[0];
                //$rt_session  = $line[1];
                $rv_full_marks      = $line[6];
                $rv_marks_obtain    = $line[7];
				$rv_percent         = $line[8];
				//$rv_result          = $line[9];
				//$rv_sgpa            = $line[10];
				$rv_stud_rollno     = $line[3];
				$rv_dob     		= $line[9];
				
                
                // Check whether member already exists in the database with the same email
                $sqlstudent = "SELECT * FROM steps_result_view WHERE rv_stud_id = '".$rv_stud_id."' and rv_semester = ".$_POST['semester_list'];
                ...
                if($sturesult->num_rows > 0){
                   ...
                   /* $conn->query("UPDATE steps_result_total SET 
					...
					$stmtqry = "UPDATE steps_result_view SET 
									rv_session 		= '".$_POST['semester_session']."',
									rv_sub_id 		= '".$_POST['sem_sub_id']."',
									rv_full_marks 	= '".$rv_full_marks."',
									rv_marks_obtain = '".$rv_marks_obtain."',
									rv_percent 		= '".$rv_percent."',
									rv_stud_rollno 	= '".$rv_stud_rollno."',
									rv_dob 		= '".$rv_dob."' WHERE rv_stud_id = '".$rv_stud_id."' and rv_semester = ".$_POST['semester_list'];
					...
					//$MessegeDataUpdated = "Data updated";
                  	 	...
                  	 	$stmtqry = "INSERT INTO  steps_result_view SET 
									rv_stud_id 		= '".$rv_stud_id."',
									rv_session 		= '".$_POST['semester_session']."',
									rv_sub_id 		= '".$_POST['sem_sub_id']."',
									rv_semester 	= '".$_POST['semester_list']."',
									rv_full_marks 	= '".$rv_full_marks."',
									rv_marks_obtain = '".$rv_marks_obtain."',
									rv_percent 		= '".$rv_percent."',
									rv_stud_rollno 	= '".$rv_stud_rollno."',
...
?>             
					...
					<li class="active">Upload Result</li>
                    </ol>
                    </div>
