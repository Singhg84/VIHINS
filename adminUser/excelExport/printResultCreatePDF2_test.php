...
$admissionsession = $_REQUEST['admission_session'];
$semestersession = $_REQUEST['semester_session'];
$subject = $_REQUEST['sem_sub_id'];
$semesterid = $_REQUEST['semester_list'];
//$studentId = $_GET['studentID'];
//print_r($_REQUEST);
if(isset($_POST["randcheck"]) && $_POST["randcheck"] == $_SESSION['rand']){  

   //echo "aa";exit;
 $sqlPrint = "SELECT * FROM steps_student_master WHERE stud_sub_id = '".$subject."' and 
			stud_previous_semester = '".$semesterid."' and stud_session_admission = '".$admissionsession."' and stud_status = 'Active' limit 0,3";
...
$output .='<tr>
		...
		file_put_contents('../../webMaster/vendor/barcode.jpg', $generator->getBarcode('081231723897', $generator::TYPE_CODE_128_B));
		//$generator->useGd();
	...
	<div class="clearfix">&nbsp;</div> 
		<div align="left"><img src="../../webMaster/vendor/barcode.jpg"></div> 		    
		<div class="clearfix">&nbsp;</div>';  
